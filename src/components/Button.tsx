  ...
  return (
    <button
      className={twMerge(
        ...
        variant === "text" &&
          "h-auto px-0 border-transparent after:content-[''] after:h-1 after:w-0 after:absolute after:top-full after:bg-red-orange-500 hover:after:w-full after:transition-all after:duration-500 after:rounded-full",
        className
      )}
      {...rest}
    >
