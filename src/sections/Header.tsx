...
export default function Header() {
  ...
  const [navItemsScope, navItemsAnimate] = useAnimate();
        ...
        <nav className="mt-20 flex flex-col">
          {navItems.map(({ label, href }) => (
            ...
            >
              ...
              <div className="absolute w-full bottom-0 h-0 bg-stone-800 group-hover/nav-item:h-full transition-all duration-500 -z-10"></div>
            </Link>
          ))}
        </nav>
      </div>
